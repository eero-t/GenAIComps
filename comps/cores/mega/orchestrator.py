...
class OrchestratorMetrics:
    # Metrics are class variables because:
    ...
    # Metric names use "megaservice_" prefix and are created on demand,
    # to avoid token metrics for services that never handle tokens.
